  ...
  setupController(controller, model) {
    ...
    const emptyStateMessage = function () {
      if (noConnectionCapabilities) {
        ...
        return 'You can connect an external database to Himitsu Vault.  We recommend that you create a user for Himitsu Vault rather than using the database root user.';
      }
    };
