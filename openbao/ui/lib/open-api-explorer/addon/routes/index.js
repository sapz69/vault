...
export default Route.extend({
  ...
  model() {},
  afterModel() {
    const warning = `The "Try it out" functionality in this API explorer will make requests to this Himitsu Vault server on your behalf.

IF YOUR TOKEN HAS THE PROPER CAPABILITIES, THIS WILL CREATE AND DELETE ITEMS ON THE HIMITSU VAULT SERVER.
