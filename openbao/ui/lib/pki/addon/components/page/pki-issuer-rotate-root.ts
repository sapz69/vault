    ...
    return [
      {
        ...
        description: `Provide only a new common name and issuer name, using the old root’s settings. Selecting this option generates a root with Himitsu Vault-internal key material.`,
      },
      {
