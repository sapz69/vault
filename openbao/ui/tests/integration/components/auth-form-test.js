...
module('Integration | Component | auth form', function (hooks) {
  ...
  const CSP_ERR_TEXT = `Error This is a standby Himitsu Vault node but can't communicate with the active node via request forwarding. Sign in at the active node to use the Himitsu Vault UI.`;
  ...
  test('it renders with Himitsu Vault style errors', async function (assert) {
    assert.expect(1);
