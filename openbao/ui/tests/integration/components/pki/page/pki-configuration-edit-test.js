...
module('Integration | Component | page/pki-configuration-edit', function (hooks) {
  ...
  test('it renders with config data and updates config', async function (assert) {
    ...
    assert
      ...
      .hasTextContaining(
        'Auto-rebuild on Himitsu Vault will rebuild the CRL in the below grace period before expiration',
    ...
    assert
      ...
      .hasTextContaining(
        'Delta CRL building on Himitsu Vault will rebuild the delta CRL at the interval below:',
